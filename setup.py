...
VERSION = __import__("django_migration_extensions").__version__
...
setup(
    name="django-migration-extensions",
    version=VERSION,
    packages=find_packages(),
    install_requires=[],
    cmdclass={"publish": PublishCommand, "tag": CreateTagCommand},
    # metadata for upload to PyPI
    description="Includes a few more batteries for Django Migrations",
    long_description=README,
    long_description_content_type="text/x-rst",
    author="Tesorio",
    author_email="hello@tesorio.com",
    url="https://github.com/Tesorio/django-migration-extensions",
    license="MIT",
    platforms=["any"],
    classifiers=[
